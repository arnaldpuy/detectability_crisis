...
```{r definitional_heterogeneity, fig.height=4, fig.width=5}
...
```{r definitions_heatmap, dependson="definitional_heterogeneity", fig.height=5, fig.width=6}
...
```{r summary_definitions, dependson="definitional_heterogeneity"}
...
## Tests: same definition versus different definition

```{r definition_tests, dependson=c("fraction_lost_k", "definitional_heterogeneity"), fig.height=2, fig.width=5}
